...
while not gameEnded:
    ...
    xSpeed, ySpeed = round(randint(4, 5)), round(randint(4, 5))
    speedIncr = 1
    speedAtt = .999
    ...
    while not gameOver:
        ...
        if pl1Direction == 'up' and pl1YPos > 0 : pl1YPos -= 8
        elif pl1Direction == 'down' and pl1YPos < displayHeight - 150 : pl1YPos += 8
        
        if pl2Direction == 'up' and pl2YPos > 0 : pl2YPos -= 8
        elif pl2Direction == 'down' and pl2YPos < displayHeight - 150 : pl2YPos += 8
